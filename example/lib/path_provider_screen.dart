...
class _PathProviderScreenState extends State<PathProviderScreen> {
  ...
  void _requestExternalStorageDirectories(StorageDirectory type) {
    setState(() {
      _externalStorageDirectories = getExternalStorageDirectories(type: type) as Future<List<Directory>>?;
    });
  }

  void _requestExternalCacheDirectories() {
    setState(() {
      _externalCacheDirectories = getExternalCacheDirectories() as Future<List<Directory>>?;
    });
  }
